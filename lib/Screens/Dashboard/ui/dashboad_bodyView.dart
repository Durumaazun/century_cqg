...
class DashboardBodyView extends StatelessWidget {
  ...
  Widget accountSumView(bool isDarkMode) {
    return Container(
      ...
      decoration: BoxDecoration(color: NerveColors.primaryColor(isDarkMode)),
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Account Summary', style: _dashboardHeadingStyle(isDarkMode)),
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                'Watched Recently',
                style: _dashboardHeadingStyle(isDarkMode),
              ),
  ...
  TextStyle _dashboardHeadingStyle(bool isDarkMode) {
    return TextStyle(
      fontFamily: 'Inter',
      fontSize: 14,
  ...
  Widget stockCard({required dynamic stock, required bool isDarkMode}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          width: 1,
          color: isDarkMode ? const Color(0x0DFFFFFF) : const Color(0x0D000000),
        ),
              ...
              Flexible(
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: '+${stock.percentageChange.toStringAsFixed(2)}',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          fontSize: 12,
